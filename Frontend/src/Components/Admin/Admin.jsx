      ...
      <div className="md:w-11/12 mx-auto bg-gray-100/10 flex p-4 my-6 mt-24">
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            <p className="text-lg text-black-100 leading-loose">
              A Mern Stack Web Developer 🚀 from Bhopal, India, currently 💻 I'm
              doing my Mern Stack Development from Sagar Institute of Science and Technology. I am passionate
        ...
        <div className="w-5/12 p-16 ml-24">
          <img
            src="./quiz.png"
            alt="admin"
            className="h-[300px] w-[300px] rounded-half "
          />
        </div>
      </div>
